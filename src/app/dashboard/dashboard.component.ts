...
export class DashboardComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    const optionsDailySalesChart: any = {
      ...
      low: 0,
      high: 50,  // Lans Deal: we recommend you to set the high sa the biggest
    ...
    const optionsCompletedTasksChart: any = {
      lineSmooth: Chartist.Interpolation.cardinal({tension: 0}),
      low: 0,
      high: 1000,  // Lans Deal: we recommend you to set the high sa the biggest
                   // value + something for a better look
      chartPadding: {top: 0, right: 0, bottom: 0, left: 0}
    }

    var completedTasksChart = new Chartist.Line(
        '#completedTasksChart', dataCompletedTasksChart,
    ...
    var websiteViewsChart = new Chartist.Bar(
        '#websiteViewsChart', datawebsiteViewsChart, optionswebsiteViewsChart,
        responsiveOptions);
